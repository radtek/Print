...
//            str = "#71110520100300012#台式电脑主机#微型数字电子计算机#1#2010-03-01##在用#征收局#商璐#征收局#征收局#计算中心#########23#6880##";
            //str = "&台式电脑主机&台式电脑主机&台式电脑主机&台式电脑主机&台式电脑主机&台式电脑主机&台式电脑主机&台式电脑主机&台式电脑主机&台式电脑主机&台式电脑主机&台式电脑主机&台式电脑主机&台式电脑主机&台式电脑主机&台式电脑主机&台式电脑主机&台式大的$";
            ...
            try
            {
                ...
                var f2 = new Font("宋体", 8, FontStyle.Bold);
                var p4 = new Point(PrinterConfig.XOFFSET, (int)PrinterConfig.GAP * 2 + PrinterConfig.YOFFSET-6);
                var p5 = new Point(PrinterConfig.XOFFSET, (int)PrinterConfig.GAP * 2 + PrinterConfig.YOFFSET+8);
                using (Graphics graphics = e.Graphics)
                {
                    //graphics.DrawString("00000", f1, b1, p4);
                    graphics.DrawString(strslist[0], f1, b1, p1);
                    if (strslist[1].Length > 9)
                    {
                        graphics.DrawString(getlength(strslist[1]), f2, b1, p4);
                        graphics.DrawString(getlength_1(strslist[1]), f2, b1, p5);
                    }
                    else
                    {
                        graphics.DrawString(strslist[1], f1, b1, p2);
                    }
                    graphics.DrawString(getlength(strslist_cy[1]), f1, b1, p3);
        ...
        private string getlength_1(string p0)
        {
            string str = "";
            if (p0.Length > 9)
            {
                str = p0.Substring(9, p0.Length-9);
            }
            else
            {
                str = p0;
        ...
        private List<string> GetRowsList()
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
  		    ...
  		    string CFDD="";
                    ...
                    {
                         CFDD= dt.Rows[i]["CFDD"].ToString();
                        if (!string.IsNullOrEmpty(CFDD))
                        {
                            if (CFDD.Substring(0, 1) == "0" || CFDD.Substring(0, 2) == "00")
                            {
                                if (CFDD == "000")
                                {
                                    CFDD = "0";
                                ...
                                {
                                    CFDD = CFDD.TrimStart('0');
                                }
                            }
                        }

                        str += GetCFDDNAME(CFDD) + "&";
                    }
                    else
                    {
                        str += "&";
