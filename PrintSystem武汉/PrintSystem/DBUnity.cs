...
namespace PrintSystem
{
    ...
    {
        public static readonly string connectionString ="server=148.20.48.193;database=FixAssetDB;User ID=sa;Password=jlsoft1234!@#$";
        //      public static readonly string connectionString ="server=59.175.153.45;database=FixAssetDB;User ID=sa;Password=lasting888"; 
        //public static readonly string connectionString ="server=.\\ADISQLSERVER;database=FixAssetDB;User ID=sa;Password=123"; 
        ...
        public static DataTable AdapterToTab(string connectionString, string SqlStr)
        {
            ...
            //MessageBox.Show(SqlStr, connectionString);
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                //MessageBox.Show("我两节进来了 ", connectionString);
                if (conn.State != ConnectionState.Open)
                {
                    conn.Open();
                    //MessageBox.Show("我打开了conn ", connectionString);
                }
                //else { MessageBox.Show("我没打开了conn ", connectionString); }
