...
//            str = "#71110520100300012#台式电脑主机#微型数字电子计算机#1#2010-03-01##在用#征收局#商璐#征收局#征收局#计算中心#########23#6880##";
             ...
             try
            {
                ...
                var padding = new Point(220 + PrinterConfig.XOFFSET, PrinterConfig.YOFFSET + 40);
                var p0 = new Point(PrinterConfig.XOFFSET + 35, PrinterConfig.YOFFSET);
                ...
                var f1 = new Font("宋体", 10, FontStyle.Bold);
                ...
                {   
                    ...
                    graphics.DrawString("取得日期： "+strslist[16], f1, b1, p4);
