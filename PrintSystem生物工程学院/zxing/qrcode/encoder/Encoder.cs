...
namespace com.google.zxing.qrcode.encoder
{
	...
	public sealed class Encoder
	{
		...
		internal const System.String DEFAULT_BYTE_MODE_ENCODING = "GB2312";
		...
		public static void  encode(System.String content, ErrorCorrectionLevel ecLevel, System.Collections.Hashtable hints, QRCode qrCode)
		{
            ...
            //appendLengthInfo(numLetters, 20, mode, headerAndDataBits);
            ...
            //qrCode.MaskPattern = chooseMaskPattern(finalBits, qrCode.ECLevel, 20, matrix);
			
			// Step 8.  Build the matrix and set it to "qrCode".
			MatrixUtil.buildMatrix(finalBits, qrCode.ECLevel, qrCode.Version, qrCode.MaskPattern, matrix);
            //MatrixUtil.buildMatrix(finalBits, qrCode.ECLevel, 20, qrCode.MaskPattern, matrix);
